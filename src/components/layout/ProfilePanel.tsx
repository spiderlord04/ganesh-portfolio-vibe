    ...
    <div className="left-panel animate-fade-in">
      <div className="flex flex-col items-center text-center space-y-6">
        <div className="relative w-48 h-48 overflow-hidden rounded-full border-4 border-teal shadow-lg">
          <img
            src="https://images.unsplash.com/photo-1500648767791-00dcc994a43e?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTR8fHByb2ZpbGUlMjBwaG90b3xlbnwwfHwwfHx8MA%3D%3D&auto=format&fit=crop&w=500&q=60"
            alt="Damerla Ganesh"
        ...
        <div className="space-y-2">
          ...
          <div className="h-8">
            <span ref={titleRef} className="typing-container animate-typing text-teal text-lg">
